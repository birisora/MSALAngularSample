...
@NgModule({
  ...
  imports: [
    ...
    MsalModule.forRoot({
      clientID: '3444cbd3-f727-47a3-8fa5-22a63a87a899',
      authority: "https://login.microsoftonline.com/Project3Authorization.onmicrosoft.com",
      ...
      popUp: false,
      // consentScopes: ["user.read", "https://google.com"],
